...
func (m *MsgPing) GetContent() string {
	if m != nil {
		return m.Content
	}
	return ""
...
func (m *MsgPong) GetContent() string {
	if m != nil {
		return m.Content
	}
	return ""
...
func init() {
	proto.RegisterType((*MsgPing)(nil), "tproto.MsgPing")
	proto.RegisterType((*MsgPong)(nil), "tproto.MsgPong")
}
...
var fileDescriptor_c161fcfdc0c3ff1e = []byte{
	...
	0xd1, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x2b, 0x01, 0xd3, 0x4a, 0xca, 0x5c, 0xec, 0xbe,
	0xc5, 0xe9, 0x01, 0x99, 0x79, 0xe9, 0x42, 0x12, 0x5c, 0xec, 0xce, 0xf9, 0x79, 0x25, 0xa9, 0x79,
	0x25, 0x12, 0x8c, 0x0a, 0x8c, 0x1a, 0x9c, 0x41, 0x30, 0x2e, 0x4c, 0x51, 0x3e, 0x3e, 0x45, 0x4e,
	0xd2, 0x27, 0x1e, 0xc9, 0x31, 0x5e, 0x78, 0x24, 0xc7, 0xf8, 0xe0, 0x91, 0x1c, 0xe3, 0x8c, 0xc7,
	0x72, 0x0c, 0x51, 0x9c, 0x7a, 0x7a, 0xfa, 0x10, 0x6b, 0x92, 0xd8, 0xc0, 0x94, 0x31, 0x20, 0x00,
	0x00, 0xff, 0xff, 0xe9, 0x4d, 0xcf, 0x9a, 0x83, 0x00, 0x00, 0x00,
}
...
func (m *MsgPong) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
